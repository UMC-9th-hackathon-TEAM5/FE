...
export default function RoleButtonTestPage() {
  ...
  return (
    <div className="min-h-screen bg-[#111] text-white p-10 flex flex-col gap-12">
      
      {/* --- 섹션 1: 단순 비주얼 테스트 (Static) --- */}
      <section>
        <h2 className="text-xl font-bold mb-4 border-b border-gray-700 pb-2">1. 스타일 갤러리 (Static Check)</h2>
        <div className="flex flex-col gap-8 items-start">
          
          {/* Default 상태 모음 */}
          <div className="flex flex-col gap-2 items-center">
            <h3 className="text-sm text-gray-400 mb-2">Default State</h3>
          ...
          {/* Active 상태 모음 */}
          <div className="flex flex-col gap-2 items-center">
            <h3 className="text-sm text-gray-400 mb-2">Active State</h3>
            <div className="flex gap-2">
      ...
      <section>
        <h2 className="text-xl font-bold mb-4 border-b border-gray-700 pb-2">2. 하나만 선택 (Radio Logic)</h2>
        <p className="text-gray-400 text-sm mb-4">현재 선택된 역할: <span className="text-green-400 font-bold">{selectedRole || '없음'}</span></p>
      ...
      <section>
        <h2 className="text-xl font-bold mb-4 border-b border-gray-700 pb-2">3. 다중 선택 (Toggle Logic)</h2>
        <p className="text-gray-400 text-sm mb-4">각각의 버튼이 독립적으로 켜지고 꺼집니다.</p>
